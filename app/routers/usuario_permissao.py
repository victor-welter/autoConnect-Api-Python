...
async def create_usuario_permissao(usuario_permissao_data: dict, db: Session = Depends(get_db)):
    try:
...
@router.delete("/delete_usuario_permissao/{id_usuario_permissao}", status_code=200)
