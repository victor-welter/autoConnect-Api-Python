...
async def create_tipo_problema(tipo_problema_data: dict, db: Session = Depends(get_db)):
    try:
...
@router.put("update_tipo_problema/{id_tipo_problema}", status_code=200)
async def update_tipo_problema_route(id_tipo_problema: int, tipo_problema_data: dict, db: Session = Depends(get_db)):
    try:
...
@router.delete("/delete_tipo_problema/{id_tipo_problema}", status_code=200)
